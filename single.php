				...
				<div class="w3_content_agilleinfo_inner">
				            ...
				            <div class="inner-agile-w3l-part-head">
							   ...
							   <div class="latest-news-agile-info">
								   <div class="col-md-8 latest-news-agile-left-content">
										...
										<div class="admin-text">
												...
												<div class="admin-text-right">
													<ul>
														<?php
														 require_once('admin/model/rating.class.php');
														 $rate = new Rating();
														 $id = $_GET['id'];
														 $rate->setMovieId($id);
														 $views = $rate->viewRating();
														//  echo '<pre>';
														//  print_r($views);
														?>
														...
														?>
														<li>
															<?php echo $value['name'].' rated'?>
															<?php
															switch ($value['rating_value']) {
																case '1':
											...
											<div class="all-comments-info">
												...
												<div class="agile-info-wthree-box">
													<form action="admin/controller/process_add_rating.php" method="POST">
				                      ...
				                      <option value="4">4</option>
													   ...
													   <div class="col-md-6 form-info">
														...
														<input type="submit" name="submit_rating" value="SEND">
													 </div>
													 <div class="clearfix"> </div>
								   ...
								   <div class="col-md-4 latest-news-agile-right-content">
										...
										<h4 class="side-t-w3l-agile">Movie <span>Details</span></h3>
										<div class="video_agile_player sidebar-player">
											<?php require_once('admin/model/connection.class.php');
											require_once('admin/model/upcoming.php');
											$viewobj=new Upcoming();
											$id = $_GET['id'];
											$viewobj->setMovieDetailsId($id);
					...
					foreach($views as $value){
											...
											?>
												...
												<p class="fexi_header"><?php echo $value['title'];?></p>
												<p class="fexi_header_para"><span>Cast<label>:</label></span><?php echo $value['cast'];?></p>
												<p class="fexi_header_para"><span>Release On<label>:</label></span><?php echo $value['release_date'];?></p>
												<p class="fexi_header_para"><span>Genre<label>:</label></span><?php echo $value['genre'];?></p>
												<p class="fexi_header_para"><span>Runtime<label>:</label></span><?php echo $value['runtime'];?></p>
